...
abstract class AppLocalizations {
  ...
  /// No description provided for @connectionText.
  ///
  /// In en, this message translates to:
  /// **'I connect'**
  ...
  /// No description provided for @financialHarmonyText.
  ///
  /// In en, this message translates to:
  /// **'Financial harmony in your groups, made simple!'**
  String get financialHarmonyText;

  /// No description provided for @constantCalculationsText.
  ///
  /// In en, this message translates to:
  /// **'Instant calculations, fairness guaranteed with TicTic!'**
  String get constantCalculationsText;

  /// No description provided for @tediousCalculationsText.
  ///
  /// In en, this message translates to:
  /// **'Tedious calculations? No thanks. Choose simplicity with TicTic!'**
  String get tediousCalculationsText;

  /// No description provided for @ticTicText.
  ///
  /// In en, this message translates to:
  /// **'TicTic : TicTic: Share your expenses with ease!'**
  String get ticTicText;
